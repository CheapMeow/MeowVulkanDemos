...
static const char* const TEXT_DEPTH_STATE = "深度模式 %s，深度格式 D32_SFLOAT";
...
static const char* const CASE_INTERFACE_TEXTS[] = {
    ...
    TEXT_NEAR_PLANE,        TEXT_FAR_PLANE,         TEXT_SECTION_FIGHTING,
    TEXT_GROUND_OFFSET,     TEXT_SECTION_WORKLOAD,  TEXT_DRAW_COMMANDS,
    TEXT_DEPTH_STATE,       TEXT_DEPTH_STANDARD,    TEXT_DEPTH_REVERSED,
