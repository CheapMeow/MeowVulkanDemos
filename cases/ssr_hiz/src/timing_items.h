...
enum TimingId {
    ...
    TIMING_CPU_RECORD_PYRAMID,   // 记录：两种金字塔的构建
    TIMING_CPU_RECORD_REFLECT,   // 记录：反射通道
    ...
    TIMING_GPU_GEOMETRY,         // 设备时间：几何通道
    TIMING_GPU_PYRAMID,          // 设备时间：金字塔构建
    TIMING_GPU_REFLECT,          // 设备时间：反射通道
    TIMING_GPU_PRESENT,          // 设备时间：输出通道
